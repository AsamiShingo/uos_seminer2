...
- 顧客デモ後の指摘に基づく仕様変更（機能モジュールの削減・ハイパーマンダラートへの改称・Slack連携追加）は [design/アプリ設計2_顧客指摘.md](design/アプリ設計2_顧客指摘.md) にまとめられています。[design/Mandalart LP.dc.html](design/Mandalart%20LP.dc.html) はこの指摘を反映済みです。詳細な数値は同ファイルの「§3 改訂2の正データ」を参照してください。
